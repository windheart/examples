define [
  ...
  'components/tour/booking/templates/default/extra-service-groups/item/service'
    ...
    templateHelpers: ->
      return {
        ...
        getPrice: (price, currentTouristQuantity) =>
          return "#{price.value} <small>X</small> #{currentTouristQuantity} = #{price.value * currentTouristQuantity or 0} #{price.currencySymbol}"
